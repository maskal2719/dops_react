        ...
        <div>
            ...
            <div className={styles.body}>
                <div className={styles.nav}>
                    ...
                    <div ><NavLink to={'/page/0'} className={({isActive})=> isActive ? styles.active : styles.navLink}>Page2</NavLink></div>
                    <div><NavLink to={'/page/1'} className={({isActive})=> isActive ? styles.active : styles.navLink}>Page3</NavLink></div>
                ...
                <div className={styles.content}>
                    <Routes>
                        ...
                        <Route path={'/page/:id'} element={<Page pages={dataState.pages}/>}></Route>
